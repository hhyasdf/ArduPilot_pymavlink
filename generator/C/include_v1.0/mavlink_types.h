...
#define MAVLINK_CORE_HEADER_LEN 6 ///< Length of core header (of the comm. layer): message length (1 byte) + message sequence (1 byte) + message system id (1 byte) + message component id (1 byte) + message group id(1 byte)+ message type id (1 byte)
